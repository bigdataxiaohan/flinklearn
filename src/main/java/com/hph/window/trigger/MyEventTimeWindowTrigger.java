...
public class MyEventTimeWindowTrigger {
    public static void main(String[] args) throws Exception {
        ...
        }).timeWindow(Time.seconds(5)).trigger(EventTimeTrigger.create()).sum(1).print();

        environment.execute("MyEventTimeWindowTrigger");
